...
fs.writeFileSync('.agent-responses-004.json', JSON.stringify(output, null, 2), 'utf8');
console.log('Generated', explanations.length, 'explanations for Subject 9 Batch 4');
